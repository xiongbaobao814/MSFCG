...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        # 分解
        self.start_fc = nn.Linear(in_features=1, out_features=self.d_model)self.trend_model = series_decomp_multi(kernel_size=[4, 8, 12])
    ...
    def forward(self, x_enc, x_mark_enc, mask=None):    # [32, 96, 7], [32, 96, 4]
        ...
        new_x = self.seasonality_and_trend_decompose(x_enc)

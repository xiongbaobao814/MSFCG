...
from layers.MSGBlock import GraphBlock, simpleVIT, Attention_Block, Project
...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.seq2pred = Project(configs.individual ,configs.c_out,configs.seq_len, configs.pred_len, configs.dropout)
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None):
        ...
        # porject back
        dec_out = self.projection(enc_out)                                  # [32, 96, 7]

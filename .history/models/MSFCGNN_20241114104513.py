...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.start_fc = nn.Linear(in_features=self.num_nodes, out_features=self.d_model)
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None): # [32, 96, 7], [32, 96, 4]
        ...
        x_out = self.start_fc(x_input)            # [32, 96, 512]
        ...
        # 3.多尺度图处理
        for i in range(self.layer):    # 2层, 共包含2个MultiScaleGraphBlock实例

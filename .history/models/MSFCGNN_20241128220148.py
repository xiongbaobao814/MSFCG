...
class GraphBlock(nn.Module):
    ...
    def forward(self, x_enc):
        ...
        ## Adaptive Pooling
        A_input_ = F.adaptive_avg_pool1d(A_input_.unsqueeze(1), 16).squeeze(1) # [224, 224]     [448,224]       
...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.projection1 = nn.Linear(self.d_model, self.c_out, bias=True)
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None):    # [32, 96, 7], [32, 96, 4]
        ...
        # 4.投影
        outputs = self.projection1(outputs)                              # [32, 96, 7]        
        out = self.seq2pred(outputs.transpose(1, 2)).transpose(1, 2)  # [32, 96, 7]

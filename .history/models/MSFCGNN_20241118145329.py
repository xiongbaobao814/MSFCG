...
class GraphBlock(nn.Module):
    def __init__(self, configs):
        ...
        self.nonlin_map2 = nn.Sequential(nn.BatchNorm1d(2*self.hidden_dim))   # 224->32
    ...
    def forward(self, x_enc):
        ...
        ## Adaptive Pooling
        A_input_ = F.adaptive_avg_pool1d(A_input_.unsqueeze(1), 224).squeeze(1)  # [224, 96]      [448,224]       

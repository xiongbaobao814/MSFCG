...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        # 编码
        self.enc_embedding = DataEmbedding(self.enc_in, 8, self.embed, self.freq, self.dropout)
        self.embed_fc = nn.Linear(8, self.c_out, bias=True)
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None):
        ...
        dec_out = self.seq2pred(outputs.transpose(1, 2)).transpose(1, 2)  # [32, 96, 7]

...
class GraphBlock(nn.Module):
    def __init__(self, configs, scale, scale_num):
    ...
    def forward(self, x_enc):
        ...
        A_input_ = F.adaptive_avg_pool1d(A_input_.size(1), 128)
...
class ScaleGraphBlock(nn.Module):
    ...
    def forward(self, x_enc):
        ...
        for i in range(self.k):
            ...
            # 构造多尺度图
            self.gconv.append(GraphBlock(self.configs, scale, scale_num))
...
class Model(nn.Module):
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None):
        ...
        A_input_ = F.adaptive_avg_pool1d(A_input_.unsqueeze(1), 128)

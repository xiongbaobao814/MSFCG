...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='MSFCGNN2', help='model name, options: [PathFormer, MSFCGNN1, MSFCGNN2]')

    # data loader
    parser.add_argument('--model_id', type=str, default="weather")
    parser.add_argument('--data', type=str, default='custom', help='dataset type')
    parser.add_argument('--root_path', type=str, default='/home/shilin/code/all_datasets/weather/', help='root path of the data file')

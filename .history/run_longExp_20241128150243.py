...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='MSFCGNN for Time Series Forecasting')
    ...
    parser.add_argument('--model', type=str, default='MSFCGNN',
    ...
    # FCMSGNN
    parser.add_argument('--conv_kernel', type=int, default=6, help='')
    parser.add_argument('--conv_out', type=int, default=2, help='')
    parser.add_argument('--lstmhidden_dim', type=int, default=48, help='')
    parser.add_argument('--lstmout_dim', type=int, default=16, help='')
    parser.add_argument('--hidden_dim', type=int, default=16, help='')
    parser.add_argument('--moving_windows', type=list, default=[2, 2], help='')
    parser.add_argument('--strides', type=list, default=[1, 2], help='')
    parser.add_argument('--decay', type=float, default=0.8, help='')
    parser.add_argument('--pooling_choice', type=str, default='mean', help='mean or add')
    # parser.add_argument('--patch_num', type=int, default=2, help='')
    ...
    parser.add_argument('--embed_type', type=int, default=1, help='0: default'
    ...
    parser.add_argument('--top_k', type=int, default=34, help='for TimesBlock/ScaleGraphBlock')

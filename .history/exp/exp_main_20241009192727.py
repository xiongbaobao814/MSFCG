...
class Exp_Main(Exp_Basic):
    ...
    def train(self, setting):
        ...
        vali_data, vali_loader = self._get_data(flag='val')     # vali_data:{data_x:(34560, 7), data_y:(34560, 7), data_stamp:(34560, 4)}
        test_data, test_loader = self._get_data(flag='test')    # test_data:{data_x:(34560, 7), data_y:(34560, 7), data_stamp:(34560, 4)}

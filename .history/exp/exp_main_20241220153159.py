...
from models import PathFormer, MSFCGNN, MSFCGNN2
...
# 初始化wandb
wandb.init(project='MSFCGNN2', name="A100-dell")
...
class Exp_Main(Exp_Basic):
    ...
    def train(self, setting):
        ...
        scheduler = lr_scheduler.OneCycleLR(optimizer=model_optim, steps_per_epoch=train_steps, pct_start=self.args.pct_start,

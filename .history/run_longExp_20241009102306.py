...
parser.add_argument('--root_path', type=str, default='/home/shilin//all_datasets/ETT-small/', help='root path of the data file')
...
parser.add_argument('--num_sensor', type=int, default=9, help='')
parser.add_argument('--n_class', type=int, default=6, help='')                                        

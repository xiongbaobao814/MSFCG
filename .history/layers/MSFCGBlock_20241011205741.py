...
class Feature_extractor_1DCNN(nn.Module):
    def __init__(self, input_channels, num_hidden, embedding_dimension, dropout=0):
        super(Feature_extractor_1DCNN, self).__init__()
        # input_channels → num_hidden: 1 → 48
        self.conv_block1 = nn.Sequential(
            nn.Conv1d(input_channels, num_hidden, kernel_size=3, 
        ...
        self.conv_block2 = nn.Sequential(
            nn.Conv1d(num_hidden, num_hidden*2, kernel_size=3, stride=1, bias=False, padding=2),
        ...
        self.conv_block3 = nn.Sequential(
            nn.Conv1d(num_hidden*2, embedding_dimension, kernel_size=3, stride=1, bias=False, padding=3),
...
def WindowConv_Graph(input, moving_window, stride):     # [32, 2, 7, 32]   

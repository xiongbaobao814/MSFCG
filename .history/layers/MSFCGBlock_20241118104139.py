...
class Feature_extractor_1DCNN(nn.Module):
    def __init__(self, input_channels, lstmhidden_dim, embedding_dimension, kernel_size=3, dropout=0):  # 1, 48, 16, 6
        ...
        self.conv_block3 = nn.Sequential(
            nn.Conv1d(lstmhidden_dim*2, embedding_dimension, kernel_size=kernel_size, stride=1, bias=False, padding=3),

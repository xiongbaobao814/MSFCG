...
class GraphConvpoolMPNN_block(nn.Module):
    ...
    def forward(self, input):   # [32, 1, 7, 32]  [32, 2, 7, 32]
        ...
        new_input_con, Adj_nodecay = self.graph_construction(input_con_)    # [32, 14, 32],[32, 14, 14] [96, 14, 32],[96, 14, 14]
        ...
        new_input_con = torch.transpose(new_input_con, -1, -2)              # [32, 14, 32] [32, 14, 32] [32, 14, 32]

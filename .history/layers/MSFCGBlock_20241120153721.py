...
class GraphConvpoolMPNN_block(nn.Module):
    ...
    def forward(self, input):   # [32, 1, 7, 32]  [32, 2, 7, 32]
        ...
        new_input_con_ = torch.reshape(new_input_con, [bs, num_windows, num_nodes, moving_window, feature_dim])
        GCNPooling_output = self.MPNN(new_input_con, Adj_decay, input_con) # [32, 7, 16]  [32, 1, 7, 16] [64, 14, 16]

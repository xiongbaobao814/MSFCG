...
class GraphConvpoolMPNN_block(nn.Module):
    ...
    def forward(self, input):   # [32, 1, 7, 32]  [32, 2, 7, 32]
        ...
        input_con_1, Adj_nodecay = self.graph_construction(input_con_)               # [32, 14, 14]  [32, 14, 14]
        Adj_decay = Adj_nodecay*self.pre_relation                       # [32, 14, 14]  [32, 14, 14]

        # 消息传递:图卷积与池化操作
        input_con_1 = torch.transpose(input_con_1, -1, -2)                # [32, 32, 7]  [32, 32, 14]
        input_con_1 = self.BN(input_con_1)
        input_con_1 = torch.transpose(input_con_, -1, -2)                # [32, 7, 32]  [32, 14, 32]
